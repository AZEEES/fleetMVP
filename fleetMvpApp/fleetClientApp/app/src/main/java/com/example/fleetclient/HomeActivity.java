...
public class HomeActivity extends AppCompatActivity implements
    ...
    private static final String TAG = "FleetClientHomeTag";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView homeImage = (ImageView) findViewById(R.id.homeImageView);
        ...
        String driver_name = credential.getDriverName();
        String driver_contact = credential.getDriverContact();
        String owner_name = credential.getOwnerName();
        String owner_business = credential.getOwnerBusiness();
        String owner_contact = credential.getOwnerContact();
        String owner_address = credential.getOwnerAddress();
        String driver_details = driver_name + "\n" + driver_contact;
        String owner_details = owner_name + "\n" + owner_business + "\n" + owner_address + "\n" + owner_contact;
        realm.copyToRealmOrUpdate(credential);
        realm.commitTransaction();
        realm.close();

        TextView driverDetails = (TextView) findViewById(R.id.home_driver_details);
        TextView ownerDetails = (TextView) findViewById(R.id.home_owner_details);
        driverDetails.setText(driver_details);
        ownerDetails.setText(owner_details);


        new AlertDialog.Builder(HomeActivity.this)
                .setTitle("Enable location tracking")
                .setMessage("Allow location tracking of the phone")
    ...
    protected void onStart() {
        ...
        if (!checkPermissions()) {
            ...
            if(mRequestLocationUpdatesButton.isEnabled()) {
//                mService.requestLocationUpdates();
//                Log.v(TAG, "Button start when service is enabled");
            }
            else {
//                Log.v(TAG, "Attempting service start when button is disabled");
//                mService.requestLocationUpdates();
            }
        }
    ...
    private void requestPermissions() {
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    findViewById(R.id.activity_home_root),
